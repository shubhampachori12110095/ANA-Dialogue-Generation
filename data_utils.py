...
def prepare_dialogue_data(data_dir, q_vocabulary_size, r_vocabulary_size, tokenizer=None):
  ...
  from_train_path = train_path + ".q"
  to_train_path = train_path + ".r"
  from_dev_path = dev_path + ".q"
  to_dev_path = dev_path + ".r"
  return prepare_data(data_dir, from_train_path, to_train_path, from_dev_path, to_dev_path, q_vocabulary_size,
                      r_vocabulary_size, tokenizer)
